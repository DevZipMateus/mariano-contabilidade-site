...
const Testimonials = () => {
  ...
  return (
    <section id="depoimentos" className="py-20 bg-gray-900/50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {testimonials.map((testimonial, index) => (
            <div 
              key={index}
              className="bg-black/50 backdrop-blur-sm p-6 rounded-xl border border-amber-600/20 hover:border-amber-600/40 transition-all duration-300 hover:-translate-y-1 group relative"
            >
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-amber-400 text-xs">{testimonial.handle}</p>
                </div>
              </div>
        ...
        <div className="text-center">
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-8 border border-amber-600/20 max-w-2xl mx-auto">
