...
const Employees = () => {
  ...
  return <section id="funcionarios" className="py-20 bg-gradient-to-br from-gray-900 via-gray-800 to-black">
              ...
              <CardContent className="p-6 text-center">
                <div className="mb-6">
                  <Avatar className="w-32 h-32 mx-auto mb-4 ring-4 ring-amber-500/20 group-hover:ring-amber-500/40 transition-all">
                    <AvatarImage src={employee.image} alt={employee.name} className="object-cover my-px py-0 px-[2px]" />
